function main() {
  ...
  function draw(){
    ...
    //azul
    matrix = m4.identity();
    matrix = m4.translate(matrix, x, yc, 0.0);
    gl.uniformMatrix4fv(matrixUniformLocation, false, matrix);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.15, 0.35, 0.6);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [0, 0, 1]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.15, 0.45, 0.52);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [0, 0, 1]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    ...
    //vermelho
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.135, -0.5, 0.4);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1, 0, 0]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.135, -0.52, 0.3);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1, 0, 0]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    ...
    matrix = m4.identity();
    matrix = m4.translate(matrix, x, yca, 0.0);
    gl.uniformMatrix4fv(matrixUniformLocation, false, matrix);
    //cabeça
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.6, 0.5, 0, 0.1, 90);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [255 / 256, 230 / 256, 185 / 256]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.1, 0.15, -0.5, 0.1, 0);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [255 / 256, 230 / 256, 185 / 256]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    ...
    //amarelo
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.15, 0, 0.8);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1, 1, 0]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    for (i = 0; i < 4; i++) {
      gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
      setCircleVertices(gl, n, 0.15, -0.2 + (i * 1.325) / 10, 0.7);
      gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
      setCircleColor(gl, n, [1, 1, 0]);
      gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    }
    ...
    //sorriso
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.3, 0.2, 0, -0.18, 0);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [255 / 256, 255 / 256, 230 / 256]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.3, 0.2, 0, -0.05, 0);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [255 / 256, 230 / 256, 185 / 256]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    ...
    //olhos
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setCircleVertices(gl, n, 0.15, 0.2, 0.18);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setCircleColor(gl, n, [1, 1, 1]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.05, 0.075, 0.2, 0.18, 0);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [0, 0, 0]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);
    ...
    //roupa
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setEllipseVertices(gl, n, 0.45, 0.2, 0, -0.7, 0);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setEllipseColor(gl, n, [135 / 256, 206 / 256, 250 / 256]);
    gl.drawArrays(gl.TRIANGLES, 0, 3 * n);

    //pescoço
    gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
    setRectangleVertices(gl, -0.1, -0.7, 0.2, 0.3);
    gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer);
    setRectangleColor(gl, [255 / 256, 230 / 256, 185 / 256]);
